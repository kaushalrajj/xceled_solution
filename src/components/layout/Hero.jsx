...
import slide1 from "../../assets/images/hero/slider1.png";
import slide2 from "../../assets/images/hero/slider2.png";
import slide3 from "../../assets/images/hero/slider3.png";
import slide4 from "../../assets/images/hero/slider4.png";
...
const slides = [
  {
    ...
    subtext: "Focused on skill development, vocational training, and career-oriented education.",
  },
  {
    image: slide2,
    heading: "Education With Purpose",
    text: "We believe education is a service to the nation — not a business.",
    subtext: "Delivering value-driven learning programs that build self-reliance and clarity.",
  },
  {
    image: slide3,
    heading: "Skills That Build Futures",
    text: "Practical training, mentorship, and innovation designed for real-world impact.",
    subtext: "Programs aligned with schools, institutions, and emerging industry needs.",
  },
  {
    image: slide4,
    heading: "Shaping a Self-Reliant India",
    text: "Creating confident individuals ready to contribute, lead, and grow.",
    subtext: "Supporting national skill missions through education, innovation, and guidance.",
  },
];
