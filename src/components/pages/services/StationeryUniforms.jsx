...
const StationeryUniforms = () => {
  return (
    ...
    >
          ...
          <div>
            ...
            <Link
              ...
              className="
                ...
                bg-sky-600 text-white font-semibold text-base sm:text-lg
      ...
      {/* ================= OUR OFFERINGS ================= */}
      <section className="mb-16 sm:mb-24 lg:mb-28">
        <h2 className="text-2xl sm:text-3xl font-semibold text-slate-900 mb-10 sm:mb-14">
          Our Offerings
        </h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10">
          {[
            ...
            >
              ...
              <h4 className="font-semibold text-slate-900 text-base sm:text-lg mb-2">
                {item.title}
              </h4>
