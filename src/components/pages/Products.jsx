  ...
  return (
    <section className="relative w-full overflow-hidden bg-gradient-to-b from-sky-50/60 via-white to-white">
      ...
      <section className="mb-20 sm:mb-28 lg:mb-32">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-10 lg:gap-12">
          {[
            {
              img: t0,
            ...
            >
              <div className="overflow-hidden rounded-t-3xl">
                <img
                  src={card.img}
                  alt={card.title}
                  className="w-full h-56 sm:h-64 object-cover transition-transform duration-700 hover:scale-[1.05]"
                />
              </div>
              ...
              <div className="p-7 sm:p-8">
                ...
                <ul className="list-disc pl-5 text-slate-600 space-y-2 mb-4 text-base">
                  {card.points.map((p, j) => (
                    <li key={j}>{p}</li>
                  ))}
                </ul>
      ...
      {/* ================= COMPONENTS SLIDER ================= */}
      <section className="bg-sky-50/60 py-16 sm:py-24 lg:py-28 mb-20 sm:mb-28">
          ...
          <div className="overflow-hidden">
            ...
            >
              {[...products, ...products].map((item, i) => (
                <div
                  key={i}
                  className="min-w-[280px] sm:min-w-[300px] mr-6"
                >
                  <div className="bg-white rounded-2xl p-5 shadow-md transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                    <img
                      src={item.img}
                      alt={item.title}
                      className="w-full h-40 object-cover rounded-lg mb-4 transition-transform duration-500 hover:scale-[1.05]"
                    />
